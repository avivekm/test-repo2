...
using MySQL.Api.Middleware;
using MySQL.Application;
using MySQL.Application.Contracts;
using MySQL.Api.Services;
using MySQL.Infrastructure;
using MySQL.Persistence;
using MySQL.Identity;
using MySQL.Api.Extensions;
using Microsoft.Extensions.Options;
using Swashbuckle.AspNetCore.SwaggerGen;
using MySQL.Api.SwaggerHelper;
