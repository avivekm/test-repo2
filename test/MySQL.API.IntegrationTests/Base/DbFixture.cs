...
namespace MySQL.API.IntegrationTests.Base
{
    public class DbFixture : IDisposable
    {
        ...
        public DbFixture()
        {
            ...
            ApplicationConnString = $"Server=mysql;Port=3307;Database={ApplicationDbName};Userid=root;Password=root;";
                    IdentityConnString = $"Server=mysql;Port=3307;Database={IdentityDbName};Userid=root;Password=root;";
                    HealthCheckConnString = $"Server=mysql;Port=3307;Database={HealthCheckDbName};Userid=root;Password=root;";
