...
namespace MySQL.API.IntegrationTests.Base
{
    public class DbFixture : IDisposable
    {
        ...
        public DbFixture()
        {
            ...
            ApplicationConnString = $"Server=localhost;Port=3308;Database={ApplicationDbName};Userid=root;Password=root;";
                    IdentityConnString = $"Server=localhost;Port=3308;Database={IdentityDbName};Userid=root;Password=root;";
                    HealthCheckConnString = $"Server=localhost=3308;Database={HealthCheckDbName};Userid=root;Password=root;";
